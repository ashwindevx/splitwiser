    ...
    <div className="mb-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
            ...
            {preview ? (
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-zinc-50">
                  Upload screenshot or image of your bill
                </p>
                <p className="mt-1 text-xs text-zinc-50">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <ol className="list-decimal ml-5 text-xs text-muted space-y-1">
            <li>Upload a photo of your bill</li>
            <li>AI scans and extracts all items and prices</li>
            <li>Shared fees (delivery, service charges, etc) are automatically split equally</li>
            <li>Add participants and assign items</li>
          ...
          >
            {isLoading ? <Loader2 className="animate-spin" /> : 'Scan Bill'}
          </Button>
        </div>
      </div>
    </div>
